...
@section('title', 'CNOSC | Jeux olympiques des jeunes')
                ...
                <div class="col-md-8">
                    <div class="content blog-list">
                        <div class="blog-wrapper clearfix">
                            ...
                            <div class="blog-media">
                                <a href="blog-single.html" title=""><img src="{{ asset('assets/upload/blog_01.jpg') }}" alt="" class="img-responsive img-rounded"></a>
                            </div><!-- end media -->
                    ...
                    <div class="content blog-list">
                        <div class="blog-wrapper clearfix">
                            ...
                            <div class="blog-media">
                                <a href="blog-single.html" title=""><img src="{{ asset('assets/upload/blog_02.jpg') }}" alt="" class="img-responsive img-rounded"></a>
                            </div><!-- end media -->
                    ...
                    <div class="content blog-list">
                        <div class="blog-wrapper clearfix">
                            ...
                            <div class="blog-media">
                                <a href="blog-single.html" title=""><img src="{{ asset('assets/upload/blog_03.jpg') }}" alt="" class="img-responsive img-rounded"></a>
                            </div><!-- end media -->
                    ...
                    <div class="content blog-list">
                        <div class="blog-wrapper clearfix">
                            ...
                            <div class="blog-media">
                                <a href="blog-single.html" title=""><img src="{{ asset('assets/upload/blog_04.jpg') }}" alt="" class="img-responsive img-rounded"></a>
                            </div><!-- end media -->
                ...
                <div class="sidebar col-md-4">
                    <div class="widget clearfix">
                        <div class="banner-widget">
                            <img src="{{ asset('assets/upload/banner.jpeg') }}" alt="" class="img-responsive img-rounded">
                        </div>
                    </div>
                    ...
                    <div class="widget clearfix">
                        ...
                        <div class="post-widget">
                            <div class="media">
                                <img src="{{ asset('assets/upload/blog_small_01.jpg') }}" alt="" class="img-responsive alignleft img-rounded">
                            ...
                            <div class="media">
                                <img src="{{ asset('assets/upload/blog_small_02.jpg') }}" alt="" class="img-responsive alignleft img-rounded">
                                <div class="media-body">
                            ...
                            <div class="media">
                                <img src="{{ asset('assets/upload/blog_small_03.jpg') }}" alt="" class="img-responsive alignleft img-rounded">
                                <div class="media-body">
