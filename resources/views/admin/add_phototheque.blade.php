...
@section('content')
    ...
    <div class="container mt-5 mb-5">
        <div class="card">
            ...
            <div class="card-body">
                <h4 class="card-title">
                    <a class="btn btn-default btn-lg" href="{{ route('app_phototheque') }}"><i class="fi-rr-arrow-left"></i> Retour</a>
                </h4><i class="fa fa-trash" aria-hidden="true"></i>
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="file" onchange="previewFile(this)" name="file" id="" class="form-control"
                                        ...
                                        <small id="helpPhoto" class="text-danger">@error('file')
                                            {{ $message }}
                                        @enderror</small><br>
